...
/***/ function(module, exports, __webpack_require__) {
	...
	Framer.Events = (__webpack_require__(11)).Events;
	
	Framer.Animation = (__webpack_require__(13)).Animation;
	...
	Framer.LinearAnimator = (__webpack_require__(14)).LinearAnimator;
	
	Framer.BezierCurveAnimator = (__webpack_require__(16)).BezierCurveAnimator;
	
	Framer.SpringDHOAnimator = (__webpack_require__(19)).SpringDHOAnimator;
	
	Framer.SpringRK4Animator = (__webpack_require__(17)).SpringRK4Animator;
	...
	Defaults = (__webpack_require__(12)).Defaults;
	...
	exports.EventEmitter = (function(superClass) {
	  ...
	  EventEmitter.prototype.removeAllListeners = function(eventName) {
	    ...
	    for (i = 0, len = ref.length; i < len; i++) {
	      listener = ref[i];
	      results.push(this.removeListener(eventName, listener));
	    }
	    return results;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animation, BaseClass, Config, Defaults, EventEmitter, Events, LayerDraggable, LayerStates, LayerStyle, NoCacheDateKey, Utils, _, layerProperty, layerValueTypeError,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty,
	  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
	...
	Events = __webpack_require__(11).Events;
	...
	Animation = __webpack_require__(13).Animation;
	
	LayerStyle = __webpack_require__(20).LayerStyle;
	
	LayerStates = __webpack_require__(21).LayerStates;
...
/***/ function(module, exports, __webpack_require__) {
	...
	_gestures.push(Events.Rotate = "rotate");
	...
	Events.isGestureEvent = function(eventName) {
	  return indexOf.call(_gestures, eventName) >= 0;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	LinearAnimator = __webpack_require__(14).LinearAnimator;
	
	BezierCurveAnimator = __webpack_require__(16).BezierCurveAnimator;
	
	SpringRK4Animator = __webpack_require__(17).SpringRK4Animator;
	
	SpringDHOAnimator = __webpack_require__(19).SpringDHOAnimator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Animator = __webpack_require__(15).Animator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Integrator = __webpack_require__(18).Integrator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	DOMEventManager = __webpack_require__(35).DOMEventManager;
...
/***/ function(module, exports, __webpack_require__) {
	...
	GestureManagerElement = __webpack_require__(36).GestureManagerElement;
	...
	DOMEventManagerElement = (function(superClass) {
	  ...
	  function DOMEventManagerElement(element1) {
	    ...
	    this._elementGestureManager = new GestureManagerElement(this.element);
	  }
	  ...
	  DOMEventManagerElement.prototype.addListener = function(eventName, listener) {
	    ...
	    if (Events.isGestureEvent(eventName)) {
	      return this._elementGestureManager.addEventListener(eventName, listener);
	    } else {
	  ...
	  DOMEventManagerElement.prototype.removeListener = function(eventName, listener) {
	    ...
	    if (Events.isGestureEvent(eventName)) {
	      return this._elementGestureManager.removeEventListener(eventName, listener);
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.GestureManagerElement = (function() {
	  function GestureManagerElement(element) {
	    this.element = element;
	    this._events = {};
	    this._manager = null;
	  }
	
	  GestureManagerElement.prototype._getEventFamily = function(eventName) {
	    var eventFamily;
	    eventFamily = void 0;
	    switch (eventName) {
	      case Events.Pan:
	      case Events.PanStart:
	      case Events.PanMove:
	      case Events.PanEnd:
	      case Events.PanCancel:
	      case Events.PanLeft:
	      case Events.PanRight:
	      case Events.PanUp:
	      case Events.PanDown:
	      ...
	      case Events.PinchMove:
	      case Events.PinchEnd:
	      case Events.PinchCancel:
	      case Events.PinchIn:
	      case Events.PinchOut:
	      ...
	      case Events.PressUp:
	        ...
	        break;
	      case Events.Rotate:
	      case Events.RotateStart:
	      case Events.RotateMove:
	      case Events.RotateEnd:
	      case Events.RotateCancel:
	        eventFamily = Events.Rotate;
	        break;
	      case Events.Swipe:
	      case Events.SwipeLeft:
	      case Events.SwipeRight:
	      case Events.SwipeUp:
	      case Events.SwipeDown:
	        eventFamily = Events.Swipe;
	        break;
	      case Events.Tap:
	      case Events.SingleTap:
	  ...
	  GestureManagerElement.prototype._getDependentRecognizersForEventFamily = function(eventFamily) {
	    var existingRecognizers, pan, pinch, rotate, swipe, tap;
	    existingRecognizers = [];
	    switch (eventFamily) {
	      case Events.Pan:
	        if (swipe = this._manager.get(Events.Swipe)) {
	          existingRecognizers.push(swipe);
	        }
	        if (rotate = this._manager.get(Events.Rotate)) {
	          existingRecognizers.push(rotate);
	        }
	        if (pinch = this._manager.get(Events.Pinch)) {
	          existingRecognizers.push(pinch);
	        }
	        break;
	      case Events.Swipe:
	        if (pan = this._manager.get(Events.Pan)) {
	      ...
	      case Events.Pinch:
	        ...
	        if (rotate = this._manager.get(Events.Pinch)) {
	          existingRecognizers.push(rotate);
	        }
	        break;
	      case Events.DoubleTap:
	        if (tap = this._manager.get(Events.Tap)) {
	  ...
	  GestureManagerElement.prototype.addEventListener = function(eventName, listener) {
	    var eventFamily, existingRecognizers, recognizer, validEvent;
	    if (this._manager == null) {
	      this._manager = new Hammer.Manager(this.element);
	    }
	    validEvent = true;
	    recognizer = void 0;
	    ...
	    switch (eventFamily) {
	      case Events.Pan:
	        if (!this._manager.get(Events.Pan)) {
	        ...
	        break;
	      case Events.Pinch:
	        if (!this._manager.get(Events.Pinch)) {
	        ...
	        break;
	      case Events.Press:
	        if (!this._manager.get(Events.Press)) {
	        ...
	        break;
	      case Events.Rotate:
	        if (!this._manager.get(Events.Rotate)) {
	        ...
	        break;
	      case Events.Swipe:
	        if (!this._manager.get(Events.Swipe)) {
	        ...
	        break;
	      case Events.Tap:
	        if (!this._manager.get(Events.Tap)) {
	        ...
	        break;
	      case Events.DoubleTap:
	        if (!this._manager.get(Events.DoubleTap)) {
	          recognizer = new Hammer.Tap({
	    ...
	    if (recognizer) {
	      ...
	      if (existingRecognizers.length > 0) {
	        this._manager.add(recognizer).recognizeWith(existingRecognizers);
	      } else {
	        this._manager.add(recognizer);
	      }
	    }
	    if (validEvent) {
	      return this._manager.on(eventName, listener);
	    }
	  };
	
	  GestureManagerElement.prototype.removeEventListener = function(eventName, listener) {
	    return this._manager.off(eventName, listener);
	  };
	
	  return GestureManagerElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("function" == TYPE_FUNCTION && __webpack_require__(38)) {
	    !(__WEBPACK_AMD_DEFINE_RESULT__ = function() {
	        return Hammer;
	    }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
